...
| `node scripts/captures-portfolio.mjs [cible]` | régénère les captures et l'aperçu de l'étude de cas sur boukamir.be (voir l'en-tête du fichier) |
| `node scripts/audit-a11y.mjs [url]` | audit d'accessibilité axe de chaque écran, dans les deux langues, et d'une manche au clavier |
